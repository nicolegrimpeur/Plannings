...
exports.getPLannings = function (req, res) {
  const id = String(req.params.id);
  const residence = String(req.params.name);
...
exports.initFile = function (id, residence, res) {
  ...
  fs.writeFileSync(path + 'plannings/' + residence + '/' + id + '.json', JSON.stringify(jours, null, 2));
...
exports.removeFile = function (id, residence, res) {
  // supprime le planning correspondant
  del([path + 'plannings/' + residence + '/' + id + '.json']).then();
  del([path + 'historique/' + residence + '/historique_' + id + '.json']).then();
...
exports.addListe = function (id, residence) {
  const liste = JSON.parse(fs.readFileSync(path + 'listPlannings.json'));
...
exports.modifListePlanning = function (residence, informations, res) {
  const liste = JSON.parse(fs.readFileSync(path + 'listPlannings.json'));
...
// ajoute un créneau
exports.addCreneau = function (informations, res) {
  ...
  if (id !== undefined && residence !== undefined && jour !== undefined && heure !== undefined && nom !== undefined && prenom !== undefined && chambre !== undefined) {
    ...
    try {
      ...
      if (planning[jour][heure].nom === '') {
        ...
        this.fs.writeFileSync(path + 'plannings/' + residence + '/' + id + '.json', JSON.stringify(planning, null, 2));
...
exports.removeCreneau = function (informations, res) {
  let id, nom, prenom, residence, chambre, jour, heure;
...
exports.remiseZero = function (id, residence, res) {
...
exports.initHistorique = function (id, residence) {
...
exports.addHistorique = function (modification, id, residence, nom, prenom, chambre, jour, heure) {
...
exports.createResidence = function (id, name, res) {
  try {
...
// créer la nouvelle résidence
exports.supprResidence = function (id, name, res) {
